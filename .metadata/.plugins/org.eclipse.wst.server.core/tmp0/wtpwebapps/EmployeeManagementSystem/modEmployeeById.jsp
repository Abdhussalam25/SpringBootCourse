...
<style>
  ...
  background-size: cover;
    ...
    <body>
          ...
          <form class="form" action="EmployeeController" method="get">
        ...
        <h5>Enter the employee id to be modified</h5>
          <label for="uname"><b>Employee Id</b></label>
          <input type="text" placeholder="Enter ID" name="searchModId" required>     
