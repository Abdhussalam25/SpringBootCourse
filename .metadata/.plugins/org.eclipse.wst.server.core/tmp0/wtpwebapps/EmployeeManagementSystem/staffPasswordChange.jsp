                      ...
                      <div class="col-lg-12  form-group">
                          ...
                          <div class="row">
                            <div id="reportrange" class="pull-center" style="cursor: pointer; width: 100%;">
                              <form class="" action="StaffPasswordController" method="post" style="margin-left: 100px;">
                              <div style="text-align: center; display: flex; margin-top: 5px; margin-bottom: 5px; font-size: 16px;">
                                <!-- <label for="userName" >  Enter UserName: </label> -->
                             <input type="text" placeholder="Enter Username" name="currentUserName" required style="margin-left: 20px; width:25vw; height: 25px;">
